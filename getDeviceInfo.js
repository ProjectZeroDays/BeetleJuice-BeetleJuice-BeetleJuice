var DeviceInfo = (function () {
    ...
    var MethodLibrary = (function () {
        return {
            ...
            // Match in Information and Library
            ...
            // Get Horizontal / Vertical Screen Status
            getOrientationStatu: function () {
                var orientationStatus = ''
                var orientation = window.matchMedia("(orientation: portrait)")
                if (orientation.matches) {
                    orientationStatus = "Vertical Screen"
                } else {
                    orientationStatus = "Cross Screen"
                }
            ...
            // Get Current Language Used on Device
            ...
            getBrowserInfo: function () {
                ...
                if (match['IE'] || match['Edge']) {
                    ...
                    switch (navigator_top) {
                        case 71: // No Favorite Bar, Edge
                            break
                        case 74: // No Favorite Bar Edge, Non-Snapped Edge
                            break
                        case 99: // There's a Collection Bar, Edge
                            break
                        case 102: // There's a Collection Bar, Non-Stick Edge
                            match['360EE'] = true
                            break;
                        case 75: // No Favorite Bar, Edge 
                            break
                        case 74: // No Favorite Bar Edge, Non-Snapped Edge
                            break
                        case 105: // There's a Collection Bar, Edge
                            break
                        case 104: // There's a Collection Bar, Non-Stick Edge
                            match['360SE'] = true
                            break
                        default:
                            break
    ...
    var LogicLibrary = (function () {
        return {
            DeviceInfoObj: function (params, callback) {
                var info = {
                    deviceType: MethodLibrary.getDeviceType(), // Type of Device 
                    OS: MethodLibrary.getOS(), // Operating System
                    OSVersion: MethodLibrary.getOSVersion(), // Operating System Version
                    screenHeight: _window.screen.height, // Screen Height
                    screenWidth: _window.screen.width, // Screen Width 
                    language: MethodLibrary.getLanguage(), // Language Currently Used on Device - Country
                    netWork: MethodLibrary.getNetwork(), // Get Network Information
                    orientation: MethodLibrary.getOrientationStatu(), // Cross-Screen or Rotation 
                    browserInfo: MethodLibrary.getBrowserInfo(), // Browser Info
                    fingerprint: MethodLibrary.createFingerprint(params.domain), // Browser Finger Print
                    userAgent: VariableLibrary.navigator.userAgent, // Contains appCodeName, appName, appVersion, language, platform info
                    geoPosition: true, // Get Geographic Location
                    date: MethodLibrary.getDate(), // Get System Time
                    UUID: MethodLibrary.createUUID() // Build Universal Unique Identity 
                }
                ...
                if (resultInfo.geoPosition) {
                    MethodLibrary.getGeoPostion(function (position) { // Get Geographic Locator
                        resultInfo.geoPosition = 'Longitude:' + position.coords.longitude + '  Latitude:' + position.coords.latitude
                        callback(resultInfo)
                    })
                } else {
                    callback(resultInfo)
